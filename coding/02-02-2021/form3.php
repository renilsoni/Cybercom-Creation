...
if (isset($_POST['submit'])) {
    if(isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['day']) && isset($_POST['month']) && isset($_POST['year']) && isset($_POST['gender']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['password']) && isset($_POST['confirmpassword'])) {
        if (empty($_POST['firstname']) && empty($_POST['lastname']) && empty($_POST['day']) && empty($_POST['month']) && empty($_POST['year']) && empty($_POST['gender']) && empty($_POST['email']) && empty($_POST['phone']) && empty($_POST['password']) && empty($_POST['confirmpassword'])) {
            ...
            $sql = "insert into form3data (firstname,lastname,dob,gender,email,phone,password) VALUES 
                    ('".$firstname."','".$lastname."','".$dob."','".$gender."','".$email."','".$phone."','".$password."')";
