...
<body>
    ...
    <div class="main">
    	...
    	<hr>
        <div>
            <form action="lib/action.php" method="POST" onsubmit="return postValidation();">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="metatitle"> Published At</label>
                        <input type="datetime-local" class="form-control" name="published" id="published" placeholder="Enter Meta Title"/>
                        <span class="error" id="errorpublished"></span>
                    </div>
                    <div class="form-group">
                ...
                <input class="btn btn-success" type="submit" id="addblogpost" name="addblogpost" value="Add Category">
            </form>
        </div>
    </div>
</body>
